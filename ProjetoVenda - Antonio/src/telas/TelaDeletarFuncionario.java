...
public class TelaDeletarFuncionario extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(campoFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String del = campoFuncionario.getText();
    int deletar = Integer.parseInt(del);
    
    Funcionario cc = RepositorioDadosFuncionario.pesquisarFuncionarioPeloCodigo(deletar);
    
    if (cc != null){
int opcao = JOptionPane.showConfirmDialog(this,cc,"Deletar? ", JOptionPane.YES_NO_OPTION);

if(opcao == JOptionPane.YES_OPTION){
RepositorioDadosFuncionario.excluirFuncionario(cc);
